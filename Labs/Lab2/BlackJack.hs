module BlackJack where
    ...
    -}
    -- A1
    hand2 = Add (Card King Hearts)(Add (Card (Numeric 2) Spades) (Add (Card (Numeric 9) Hearts ) Empty))
    hand1 = Add(Card Ace Clubs)(Add (Card (Numeric 2) Hearts)(Add (Card Queen Spades) (Add (Card (Numeric 7) Hearts ) Empty)))
    empty :: Hand
    empty  = Empty
